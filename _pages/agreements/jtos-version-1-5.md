...
The Provider maintains relationships with a variety of counterparties and intermediaries across a range of markets. Clients whose risk profile, governance requirements, or contractual expectations exceed what a direct engagement can accommodate are encouraged to explore those channels. Clients who need bespoke contractual arrangements, higher insurance thresholds, or extensive legal negotiation are likely better served engaging through one of those routes. These terms are held out unchanged regardless of the commercial structure through which the Provider is engaged. Where an intermediary operates their own terms above or alongside this Agreement, those terms do not modify, supersede, or vary the JTOS as between the Provider and the named end Client. Where the Jube software is used or deployed in connection with any engagement, the AGPLv3 licence is in effect by operation of law, regardless of the commercial structure above it.

For the avoidance of doubt, the infrastructure sign-off, Runbook, and Expert of Record obligations set out in this Agreement are directed solely at architectural and deployment decisions that carry a material risk of service impairment. They are not intended to create approval dependencies, oversight obligations, or any restriction whatsoever in relation to the free and liberal use of documented Jube platform functionality, which remains entirely at the discretion of the Client or intermediary. The distinction between infrastructure oversight and platform use is foundational to this Agreement and shall be construed accordingly.

Where Services are engaged through an intermediary, the Provider commits that any direct communication with the named end Client, as provided for in Section 21, is operational in nature and shall not be used as a mechanism to establish a direct commercial relationship that displaces or circumvents the intermediary's role. The Provider has no commercial interest in operating outside its defined position in the value chain — being the training, implementation, and support of the Jube platform — and actively relies on intermediaries and partners to extend that capability into markets and client relationships that a direct engagement model could not reach. Co-delivery arrangements, as set out in Section 23, are the clearest expression of that model: the Provider participating as a specialist technical contributor within the intermediary's delivery structure, not as a replacement for it. This commitment is not merely contractual; it reflects the Provider's genuine dependence on, and respect for, the value chain through which Jube reaches the clients it is built to serve. Intermediaries can therefore engage the Provider's direct communication rights with confidence that those rights exist to protect the integrity of the Services and the interests of the end Client, and for no other purpose.
...
All three service lines operate on the same underlying payment model — prepaid Hour Blocks, monthly billing cycle, and consistent commercial rhythm — reflecting the Provider's commitment to a fair, transparent, and predictable engagement for both parties.
...
**Expert of Record:** A formal designation, available under Enterprise Support arrangements, whereby the Provider acts as the named technical authority on the Client's Jube implementation for the purposes of governance, audit, regulatory documentation, and internal sign-off processes. The Expert of Record designation is contingent on the conditions set out in Section 16.

**Runbook:** A documented, step-by-step procedural guide governing infrastructure changes, deployments, and operational interactions with the Jube environment, agreed between the Provider and the Client at the commencement of an engagement or Enterprise Support arrangement, and updated by mutual agreement as the environment evolves.

**PAYG (Pay As You Go):** A support arrangement under which a certified Client accesses ongoing Services without a minimum annual commitment. PAYG engagements operate on a prepaid Hour Block model and monthly billing cycle. The absence of a minimum commitment period and ancillary service obligations distinguishes PAYG from Enterprise Support; payment timing, block mechanics, and billing rhythm are otherwise identical.

**Enterprise Support:** A support arrangement under which a certified Client commits to a minimum annual engagement, with access to callout obligations, Expert of Record designation, and Runbook authority as set out in Section 16. Enterprise Support operates on the same prepaid Hour Block model and monthly billing cycle as PAYG, with a larger minimum block size as specified in the applicable Work Order. The premium of Enterprise Support is the level of committed service and ancillary obligations, not a different payment model.

**Hour Block:** A prepaid allocation of hours purchased by the Client in advance as a condition of commencing or continuing Services under a Work Order. The minimum Hour Block for Training and Integration and PAYG engagements is ten (10) hours. The minimum Hour Block for Enterprise Support engagements is as specified in the applicable Work Order. Hour Blocks are drawn down as hours are recorded against the Client's project during each monthly billing period. Advance payments in respect of Hour Blocks are treated by the Provider as deferred revenue, held in custody against hours to be delivered, and are not recognised as earned income until the corresponding hours have been recorded and reported to the Client. This reflects the Provider's position as custodian of prepaid funds rather than immediate beneficiary, and underpins the refund obligations set out in this Agreement.

**Block Balance:** The running total of prepaid hours remaining in the Client's current Hour Block within the active billing period, calculated as the Hour Block size less hours recorded against the Client's project since the block was funded. The Block Balance is reported to the Client on each monthly invoice regardless of whether a payment is due. Any positive Block Balance remaining at the close of a billing period is recognised as earned by the Provider in accordance with clause 2.6 and does not carry forward, except where agreed in writing by the Provider in respect of an Enterprise Support engagement under clause 2.7.

**.jemp:** A Jube Encrypted Message Pack file, being a compressed, encrypted, binary serialisation of a Jube tenant configuration export, produced via the configuration export functionality within the Jube platform. A .jemp contains all tenant configuration data and all subordinate definitions, but expressly excludes production data including transaction archive data, case data, cache data, and user configuration.
...
1. Fees for the Services will be as set out in the applicable Work Order, which shall specify the hourly rate and the Hour Block size applicable to the engagement. In the case of Training and Integration, the Work Order shall specify the fixed fee for the training delivery component and the hourly rate applicable to the integration support component, which operates on the same Hour Block model as PAYG.
2. All fees are exclusive of taxes, which shall be payable by the Client in addition.
3. All engagements operate on a monthly billing cycle. An invoice is issued at the end of each calendar month regardless of whether a payment is due, and is accompanied by a Time Record showing hours recorded during the month and the closing Block Balance for that period. Where the closing Block Balance reflects a partial or full unused balance, that balance shall have been recognised as earned by the Provider in accordance with clause 2.6, and the Time Record shall reflect this accordingly. A zero-value invoice accompanied by a Time Record constitutes a valid monthly statement for the purposes of this Agreement.
4. Training and Integration engagements are invoiced in two parts. The training delivery component is a fixed fee as particularised in the applicable Work Order, due and payable upon Work Order acceptance; no delivery shall commence until this fee has cleared. The integration support component begins on completion of initial training delivery as confirmed by the Provider in writing, and operates on exactly the same prepaid Hour Block model and monthly billing cycle as a PAYG engagement: the Client funds an initial Hour Block before integration support commences, hours are drawn down as recorded, overages are invoiced monthly, and any unused balance at the close of each billing period is recognised as earned by the Provider in accordance with clause 2.6. The integration support component continues until certification and pre-production deployment are confirmed, at which point the engagement concludes and transitions to PAYG or Enterprise Support. There is no lump sum second instalment and no ringfenced block; the Client funds only what they reasonably expect to use each month. In the event of termination of a Training and Integration engagement prior to completion, the training delivery fixed fee is non-refundable. Any funded and unexpired Hour Block balance within the integration support component at the effective termination date shall be refunded to the Client in full within thirty (30) days, less any outstanding amounts owed to the Provider under the Agreement, in accordance with clause 2.8.
5. Prior to commencement of any PAYG, Enterprise Support, or Training and Integration integration support Work Order, the Client shall pay the initial Hour Block in advance. No work shall commence until the initial Hour Block advance has cleared. This condition applies equally to all three engagement types.
6. At the end of each monthly billing period, the Provider shall issue a monthly invoice reconciling hours recorded during that period against the Block Balance. Where hours recorded result in a Block Balance above zero at the close of the billing period, any unused balance shall be recognised as earned by the Provider and shall not carry forward to the subsequent period. This reflects the nature of the Hour Block as consideration for the Provider's availability and commitment during the period, and not solely for hours consumed. Clients are therefore encouraged to deposit only the hours they reasonably anticipate requiring within each billing period. Where hours recorded result in a Block Balance at or below zero, the overage shall be invoiced and shall be payable within thirty (30) days. Where the Block Balance is exhausted at the close of a billing period, the Provider shall include an invoice for a further Hour Block within the monthly statement, and work shall not resume in the subsequent billing period until such invoice has been paid and cleared. The Client shall not be entitled to claim service disruption or breach arising from any suspension of work resulting from the Client's failure to replenish an exhausted Hour Block in a timely manner.
7. Notwithstanding clause 2.6, in respect of Enterprise Support engagements only, the Provider may, at its sole discretion, agree to carry forward an unused Block Balance into the subsequent billing period where this is consistent with the broader project cadence and the ongoing service relationship. Any such carryover shall not be automatic or assumed, shall not constitute a contractual entitlement on the part of the Client, and shall only be agreed where discussed and confirmed between the parties prior to the close of the relevant billing period, typically in the context of a monthly account review. The Provider's discretion in this regard reflects the nature of Enterprise Support as a wider availability and assurance arrangement, within which hour consumption in any given period may not fully represent the value of the Provider's commitment and readiness during that period.
8. Upon termination of a PAYG or Enterprise Support Work Order, any Hour Block paid in advance in respect of a billing period that has not yet commenced shall be refunded to the Client in full within thirty (30) days of the effective termination date, less any outstanding amounts owed to the Provider under the Agreement. For the avoidance of doubt, no refund shall be due in respect of any billing period that has commenced, the unused balance of which shall be recognised as earned by the Provider in accordance with clause 2.6.
9. If any payment is not made when due, the Provider reserves the right to charge statutory interest at the rate applicable under the Late Payment of Commercial Debts (Interest) Act 1998, accruing daily until payment is received in full.
10. To the extent that on-site visits to the Client's premises (or any other location) are required, the Provider shall be entitled to charge for reasonable travel and subsistence expenses. Such expenses will be billed in accordance with the HMRC international scale rate directory (as updated from time to time — see [HMRC guidance](https://www.gov.uk/guidance/expenses-rates-for-employees-travelling-outside-the-uk)) and must be agreed with the Client in advance.
11. Where the Provider is registered for Value Added Tax (VAT) with HMRC, applicable VAT will be charged on fees at the prevailing rate and shown separately on invoices. Clients outside the UK should satisfy their own VAT or equivalent obligations in their respective jurisdictions.
12. Any discount agreed between the parties is a confidential commercial arrangement and forms part of the applicable Work Order. Neither the Client nor any intermediary shall disclose the existence or terms of any discount to any third party without the prior written consent of the Provider.
13. Where Services are engaged through an intermediary, fees remain payable to the Provider in full in accordance with the applicable Work Order, regardless of whether the intermediary has collected payment from the end Client. The intermediary's failure to collect from the end Client shall not constitute grounds for withholding or reducing payment to the Provider.

## 3. Service Delivery

The Provider operates an async-first service delivery model. The primary working channels are **WhatsApp Business** and **Microsoft Teams**, through which the majority of day-to-day service activity is conducted. These channels support direct, responsive communication without the overhead of scheduled meetings, and are actively monitored during UK business hours.

Email is reserved for formal business communications and notices — including Work Order acceptance, Service Activation Letters, written sign-offs, and other communications where a traceable formal record is required. Email is not regularly monitored for day-to-day service requests and is not an appropriate channel for ongoing technical dialogue. Where an email initiates a service request or raises a technical matter, the Provider will typically acknowledge receipt by email and continue the dialogue through the appropriate async support channel rather than by email thread.
...
Service requests may be submitted through either of the following channels, which the Provider treats as equivalent primary channels for the purposes of response, logging, and billing:

* **WhatsApp Business** (dedicated support contact or group, or a subordinate channel where volume or complexity warrants separation)
* **Microsoft Teams** (dedicated support channel or group, or a subordinate channel where volume or complexity warrants separation)

Where a matter is time-sensitive or urgent, the Client should contact the Provider via WhatsApp Business, which is the only channel guaranteed to generate an audible alert regardless of the Provider's current activity. Microsoft Teams notifications are subject to device and availability settings and cannot be guaranteed to interrupt. Email cannot be relied upon for urgent matters under any circumstances.

The Provider will not be obliged to monitor or respond to service requests submitted through any other channel, including client-operated platforms, ticketing systems, or tools not listed above.
...
4. Service Management: All service requests are recorded and tracked by the Provider against the relevant Client project for the purposes of time recording and billing. The Provider maintains internal records using its own tools and processes. Clients do not have direct access to the Provider's internal tracking systems; time records are instead submitted to the Client monthly in accordance with the Time Records definition above.
...
1. Either party may terminate a PAYG engagement by giving not less than one (1) month's prior written notice to the other party.
2. Either party may terminate an Enterprise Support engagement by giving not less than three (3) months' prior written notice to the other party.
3. Training and Integration engagements may be terminated by either party upon written notice at any point prior to completion. Upon termination: the training delivery fixed fee is non-refundable and shall be retained by the Provider in full as consideration for the training programme delivered or commenced; any funded and unexpired Hour Block balance within the integration support component at the effective termination date shall be refunded to the Client in full within thirty (30) days, less any outstanding amounts owed to the Provider under the Agreement, in the same manner as a PAYG termination under clause 2.8. No minimum notice period shall apply to the termination of a Training and Integration engagement.
4. Either party may terminate any engagement with immediate effect by written notice if the other party materially breaches these Terms and fails to remedy such breach within thirty (30) days of receiving written notice specifying the breach in reasonable detail.
5. Upon termination of any engagement, the Client shall pay the Provider for all Services performed and expenses incurred up to the effective date of termination. In respect of PAYG and Enterprise Support engagements, fees paid in advance in respect of the applicable notice period shall be retained by the Provider on a pro-rata basis; any fees paid in advance beyond the notice period shall be refunded in accordance with clause 2.8.
...
Where an intermediary makes unauthorised technical representations about the Jube platform to an end Client or third party, the intermediary shall indemnify the Provider against any claims, losses, or liabilities arising from such representations.
...
1. Enterprise Support and Expert of Record arrangements are contingent on the Client maintaining infrastructure and operational practices approved by the Provider. All infrastructure changes, deployments, and architectural decisions must be reviewed and signed off by the Provider prior to implementation, in accordance with a Runbook agreed between the parties at the commencement of the engagement. The Provider shall not unreasonably withhold or delay infrastructure sign-off. For the avoidance of doubt, this sign-off requirement applies to infrastructure, deployment, and architectural decisions only. The Client is free to configure, operate, and manage documented Jube functionality — including .jemp migration, case management, rules, and analytics configuration — without prior Provider sign-off.
2. The Client shall not modify Jube's software architecture outside of supported and documented extension functionality as defined in the platform documentation. Configuration of documented functionality is not restricted. The distinction between configuration and architectural modification is as documented in the Jube platform documentation and, in the event of dispute, the Provider's written technical assessment shall constitute the reference position for the purposes of any ADR process under Section 10.
3. Where infrastructure changes are made without prior Provider sign-off, or where undocumented modifications are introduced outside the supported extensibility framework, the Provider reserves the right to suspend Enterprise Support, Expert of Record obligations, and callout commitments until such time as the environment is reviewed, documented, and approved by the Provider.
4. The Provider's callout obligations under any Enterprise Support arrangement are contingent on clauses 16.1 and 16.2 being observed. The Provider accepts no liability for incidents arising from infrastructure changes or modifications made outside the agreed Runbook and documented extension framework.
5. The Client shall ensure that any personnel with access to the Jube infrastructure and production environment have demonstrated competence appropriate to their role, as assessed through the Jube training and certification programme or by prior written agreement with the Provider. Where incidents can be attributed to actions taken by personnel operating outside the agreed Runbook or without appropriate certification, the Provider reserves the right to suspend support obligations and to treat the incident as outside the scope of the Services.
6. In the event of dispute regarding the technical assessment of the Jube environment, the Provider's written assessment shall constitute the reference position, subject to the ADR process in Section 10.
7. The Runbook shall be maintained as a living document, updated by the Provider following any material change to the environment. No change to infrastructure or deployment configuration shall be considered authorised unless it is reflected in the current agreed Runbook. The Client shall not amend or supplement the Runbook unilaterally.
8. For the purposes of this Agreement, the Jube infrastructure operated on behalf of the Client comprises all Runbooks, configuration files, deployment manifests, environment variable definitions, and program units maintained by the Provider. These assets are Provider-maintained and constitute the authoritative operational baseline for the Client's Jube environment. The Client and any intermediary shall not modify, supplement, or replace any Provider-maintained infrastructure asset without prior written approval from the Provider. Unauthorised modifications shall constitute a material breach of this Section and entitle the Provider to suspend Enterprise Support and Expert of Record obligations in accordance with clause 16.3.
9. Where a Client transitions to an Enterprise Support arrangement from an existing deployment not previously under Provider management, no Enterprise Support obligations — including callout, Expert of Record, and guaranteed response commitments — shall take effect until the Provider has reviewed the existing environment, agreed a Runbook, and issued written confirmation that the environment meets the Provider's standards for supported operation. Until such confirmation is issued, support is provided on a best endeavours basis only.

## 17. Diagnostic Information Requirements

1. As a condition of support engagement, the Client shall provide the Provider with sufficient diagnostic information to assess and investigate the reported issue. The minimum required information is:
...
1. Where Services are engaged through an intermediary, the Provider reserves the right to communicate directly with the named end Client in connection with the delivery of Services, the performance of obligations under these Terms, or the exercise of its rights, including but not limited to:
   ...
   d. any circumstance where the intermediary's conduct may affect the Provider's ability to perform its obligations or protect its interests.
2. The exercise of this right shall not be construed as bypassing or replacing the intermediary's role under the applicable Work Order, but as a necessary safeguard in the interests of the end Client and the integrity of the Services.
3. Intermediaries shall not instruct or seek to prevent the Provider from communicating directly with the named end Client.

## 22. Professional Indemnity and Liability Insurance

The Provider maintains Professional Indemnity insurance of GBP 1,000,000 per claim and Public Liability insurance of GBP 1,000,000 per claim, with a UK-authorised insurer rated to a standard appropriate for commercial engagements of this nature. Evidence of current coverage is available on request.

These coverages reflect the nature and scale of the Services. Clients whose governance requirements call for higher indemnity thresholds are encouraged to consider engaging through a larger implementation partner or system integrator within whose value chain the Provider may participate in a capacity that is commercially and contractually appropriate for all parties.
...
1. Co-delivery is a distinct service arrangement under which the Provider works alongside an intermediary's team in the direct delivery of a Jube implementation to an end Client. Co-delivery is not a support service, does not form part of any existing support arrangement, and is not included within Technical Presales. Any co-delivery engagement requires a separate Work Order.
2. The Provider reaffirms, in the context of any co-delivery engagement, its commitment to operating within its defined part of the value chain as set out in the Preamble. The Provider's participation is as a specialist technical contributor and for no other purpose.
3. Where an intermediary repeatedly draws on Provider time in connection with their own client delivery — whether framed as support queries, presales activity, or otherwise — and that activity is determined by the Provider to be substantively co-delivery in nature, the Provider reserves the right to recharacterise and invoice that time as co-delivery at the applicable rate, and to require a co-delivery Work Order before continuing engagement.
4. The Provider's role in a co-delivery engagement is as a specialist technical contributor alongside the intermediary's team. It does not constitute assumption of the intermediary's delivery obligations, project management responsibilities, or client relationship. The intermediary remains solely responsible for their own delivery commitments to the end Client.
5. Intellectual property produced during a co-delivery engagement shall vest in accordance with Section 6, as particularised in the applicable Work Order. Where Deliverables are produced jointly by the Provider and the intermediary's team, the Work Order shall specify ownership clearly. In the absence of such particularisation, IP produced by the Provider shall vest in the end Client upon payment of the Provider's fees, and IP produced solely by the intermediary's team shall remain with the intermediary or vest in the end Client as agreed between those parties independently.
6. The intermediary shall ensure that the end Client is informed of the Provider's role and independent status prior to commencement of any co-delivery engagement, consistent with Section 15.
7. Co-delivery engagements are only available where the Provider assumes the Expert of Record role for the full duration, with all associated infrastructure sign-off and Runbook authority as set out in Section 16. The Provider will not enter a co-delivery engagement unless satisfied, at its sole discretion, that it can exercise that authority meaningfully — including that the intermediary's team will operate within the agreed framework, that the technical environment is suitable for Provider sign-off, and that the intermediary has genuinely ceded technical authority for the duration. Where the Provider determines at any point during co-delivery that these conditions are no longer met, it reserves the right to suspend or terminate the co-delivery Work Order without liability. The Provider will not enter into a co-delivery engagement on any other basis.
