...
- Direct access to the developer during the course and pilot period
- Maximum 8 participants per cohort (minimum 4 to run)
...
*(All public and private training is built from the same structured curriculum — the difference is cohort size and customization.)*
...
- **Day 4–5 (Optional, Developers):** Advanced Developer Workshops
